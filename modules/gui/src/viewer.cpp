...
void gui::viewer::_mouse_callback(GLFWwindow* window, double pos_x, double pos_y)
{
...
void gui::viewer::_scroll_callback(GLFWwindow* window, double, double offset_y)
{
    assert(window); // maybe if (!window) ?
...
void gui::viewer::_handle_mouse(double pos_x, double pos_y)
{
    if (m_first_mouse)
    {
        m_last_x = pos_x;
...
void gui::viewer::_handle_scroll(double offset_y)
{
